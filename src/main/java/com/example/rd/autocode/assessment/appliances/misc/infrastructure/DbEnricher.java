...
import com.example.rd.autocode.assessment.appliances.appliance.AiAssistant;
...
//        log.error("Error");
        ...
        applianceRepository.findAll().forEach(a-> {
            Map<String, Object> metadata = new HashMap<>();
            metadata.put("id", a.getId());
            vectorStore.add(Collections.singletonList(new Document(a.getDescription(), metadata)));
        });

        String response = aiAssistant.chat("I want place to store food");
